...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/user/meloam/ZJetToMuMu_Pt-80to120_TuneZ2star_8TeV_pythia6/None/20130206162922/00000/407A66CB-E175-E211-BCF0-003048F316E8.root')
)
...
process.pfTupleEle = cms.EDFilter("EDSHyFTSelector",
    ...
    shyftSelection = cms.PSet(
        ...
        jecPayloads = cms.vstring('Jec12_V3_MC_L1FastJet_AK5PFchs.txt', 
...
process.pfTupleEleLoose = cms.EDFilter("EDSHyFTSelector",
    matchByHand = cms.bool(False),
    shyftSelection = cms.PSet(
        ...
        muTrig = cms.string('HLT_Mu9'),
        jetSrc = cms.InputTag("goodPatJetsPFSF"),
        identifier = cms.string('AK5 PF Loose electrons'),
        pvSrc = cms.InputTag("goodOfflinePrimaryVertices")
    ),
    useData = cms.bool(False)
)
...
process.pfTupleEleMetRes090 = cms.EDFilter("EDSHyFTSelector",
    matchByHand = cms.bool(False),
    shyftSelection = cms.PSet(
        muonSrc = cms.InputTag("selectedPatMuonsPFlow"),
        dxy = cms.double(0.02),
...
process.pfTupleEleMetRes110 = cms.EDFilter("EDSHyFTSelector",
    matchByHand = cms.bool(False),
    shyftSelection = cms.PSet(
        muonSrc = cms.InputTag("selectedPatMuonsPFlow"),
        dxy = cms.double(0.02),
...
process.pfTupleMu = cms.EDFilter("EDSHyFTSelector",
    matchByHand = cms.bool(False),
    shyftSelection = cms.PSet(
        muonSrc = cms.InputTag("selectedPatMuonsPFlow"),
        dxy = cms.double(0.02),
...
process.pfTupleMuLoose = cms.EDFilter("EDSHyFTSelector",
    matchByHand = cms.bool(False),
    shyftSelection = cms.PSet(
        muonSrc = cms.InputTag("selectedPatMuonsPFlowLoose"),
        dxy = cms.double(0.02),
        ...
        muTrig = cms.string('HLT_Mu9'),
        jetSrc = cms.InputTag("goodPatJetsPFSF"),
        identifier = cms.string('AK5 PF Loose muons'),
        pvSrc = cms.InputTag("goodOfflinePrimaryVertices")
    ),
    useData = cms.bool(False)
)
...
process.pfTupleMuMetRes090 = cms.EDFilter("EDSHyFTSelector",
    matchByHand = cms.bool(False),
    shyftSelection = cms.PSet(
        muonSrc = cms.InputTag("selectedPatMuonsPFlow"),
        dxy = cms.double(0.02),
...
process.pfTupleMuMetRes110 = cms.EDFilter("EDSHyFTSelector",
    matchByHand = cms.bool(False),
    shyftSelection = cms.PSet(
        muonSrc = cms.InputTag("selectedPatMuonsPFlow"),
        dxy = cms.double(0.02),
